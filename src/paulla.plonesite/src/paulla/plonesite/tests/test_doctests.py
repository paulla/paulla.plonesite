...
from paulla.plonesite.testing import PAULLA_PLONESITE_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING
...
def test_suite():
    """."""
    logger = logging.getLogger('paulla.plonesite.tests')
    ...
    try:
        ...
        logger.warn('No doctests for paulla.plonesite')
